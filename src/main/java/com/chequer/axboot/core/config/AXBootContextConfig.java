...
public class AXBootContextConfig implements ApplicationContextAware {
    ...
    private DataSourceConfig2 dataSource2;
    ...
    //DataSource 추가 20210329 KHJ
    private String domainPackageName2;
    ...
    //DataSource 추가 20210329 KHJ
    public DataSourceConfig2 getDataSourceConfig2() {
        return dataSource2;
    }
    ...
    public static class DataSourceConfig {
        ...
        public String getValidationQuery() {
            ...
            System.out.println(">>>>> datasource 1" + driverClassName);
        ...
        public DataSourceConfig() {
            System.out.println(">>>>>>> dataSourceConfig1");
    ...
    public static class DataSourceConfig2 {
        //@Getter(AccessLevel.NONE)
        @Value("${axboot.dataSource2.databaseType}")
        private String databaseType;
        @Value("${axboot.dataSource2.username}")
        private String username;
        @Value("${axboot.dataSource2.password}")
        private String password;
        @Value("${axboot.dataSource2.url}")
        private String url;
        @Value("${axboot.dataSource2.driverClassName}")
        private String driverClassName;
        @Value("${dataSource2.databaseType}")
        ...
        public String getValidationQuery() {
            String _driverClassName = driverClassName.toLowerCase();
            System.out.println(">>>>> datasource 2" + driverClassName);
            if (_driverClassName.contains("mysql") ||
                    _driverClassName.contains("mariadb") ||
                    _driverClassName.contains("microsft") ||
                    _driverClassName.contains("sqlserver")) {
        ...
        public DataSourceConfig2() {
            ...
            System.out.println(">>>>>>> dataSourceConfig2");
            System.out.println(">>>>>>> " + databaseType);
            System.out.println(">>>>>>> " + databaseType2);
            System.out.println(">>>>>>> " + databaseType1);
        }
