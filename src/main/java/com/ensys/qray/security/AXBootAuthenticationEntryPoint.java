...
import com.ensys.qray.AXBootSecurityConfig;
...
public class AXBootAuthenticationEntryPoint extends BasicAuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException) throws IOException, ServletException {
        ...
        if (authException instanceof BadCredentialsException || authException.getCause() instanceof BadCredentialsException) {
            apiResponse = ApiResponse.error(ApiStatus.SYSTEM_ERROR, "비밀번호가 일치하지 않습니다.");
        } else if (authException instanceof UsernameNotFoundException || authException.getCause() instanceof UsernameNotFoundException) {
