package com.ensys.qray.web.v1.api;
...
public interface ApiMapper extends MyBatisMapper {
    ...
    List<HashMap<String, Object>> getPrivateLoanMainJob(HashMap<String, Object> param);
    ...
    HashMap<String, Object> getPrivateLoanCommunityDetail(HashMap<String, Object> param);
