        ...
        <script type="text/javascript">
            ...
            function buildCalendar() {//현재 달 달력 만들기
                ...
                for (i = 1; i <= lastDate.getDate(); i++) {
                    ...
                    cell = row.insertCell();//열 한칸한칸 계속 만들어주는 역할
                    cell.innerHTML =
                        "<table ondblclick='javascript:DblClickFunction()' onclick='javascript:clickFunction(" + '"' + i + '"' + ")' style='height: 100%;' id='table" + i + "'>" +
                        "<tr>" +
                    ...
                    if (cnt % 7 == 1) {/*일요일 계산*/
                        ...
                        cell.innerHTML =
                            "<table ondblclick='javascript:DblClickFunction()' onclick='javascript:clickFunction(" + '"' + i + '"' + ")' id='table" + i + "'>" +
                            "<tr>" +
