                ...
                <div class="list">
                    ...
                    <c:forEach var="item" items="${list}">
                        <ul class="item">
                            ...
                            <!-- 작성자 (WRITE_IP) -->
                            <li class="writer"><c:out value="${item.WRITE_IP}" /></li>
                            <!-- 조회수 VIEW_CNT -->
                            <li class="view"><fmt:formatNumber value="${item.VIEW_CNT}" pattern="#,###" />회</li>
                            <!-- 날짜 (INSERT_DATE: 20240518211046 → yyyy-MM-dd HH:mm) -->
                            <li class="date"><c:out value="${item.INSERT_DATE_FORMATTED}" /></li>
                        </ul>
                    </c:forEach>
