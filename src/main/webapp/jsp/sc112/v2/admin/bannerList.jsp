...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <h3>광고 이미지 관리</h3>
            <a class="btn btn-add" href="/sc112/admin/banner/detail?TABLE_ID=${param.TABLE_ID}">신규 이미지 추가</a>
        </div>
        ...
        <div class="table-responsive">
            <table>
                ...
                <c:forEach var="item" items="${bannerList}">
                    <tr>
                        <td style="text-align: center; color: #888;">${item.FILE_SEQ}</td>
                        <td style="text-align: center;">
                            <a class="btn-edit" href="/sc112/admin/banner/detail?TABLE_ID=${item.TABLE_ID}&FILE_SEQ=${item.FILE_SEQ}">수정</a>
                        </td>
                        <td class="title-cell">${item.REMARK}</td>
