    ...
    <div class="wrap">
        <section id="contain">
            <div id="bbs_consult">
                ...
                <div class="consult">
                    <div class="subject">
                        <div class="title">채널링크로 문의주시면 상담드리겠습니다.</div>
                        <div class="info">
                            <p>키륵키륵</p>
                    ...
                    <div class="content">
                        <a href="#"><img src="/jsp/sc112/v2/assets/img/counsult.png" style="display:block;margin:0 auto 20px"></a>
                        <p>채널을 추가하시면</p>
                        <br>
                        <p>로드뷰나 지도를 손쉽게 사용하실 수 있고,</p>
                        <br>
                        <p>여러 의뢰인들이 남긴 후기 댓글도 보실 수 있습니다.</p>
                        <p>[출처] http://pf.kakao.com/_QFJzb (변호사 최성중 법률사무소 카카오 채널 링크 안내)|작성자 변호사 최성중</p>
                    </div>
                </div>
                <div class="inquiry">
