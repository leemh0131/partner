...
<ax:set key="title" value="광고 패키지 도움창"/>
            ...
            var ACTIONS = axboot.actionExtend(fnObj, {
                ...
                PAGE_SEARCH: function (caller, act, data) {
                    ...
                    for (var i = 0; i < temp.length; i++) {
                        chkArr.push(temp[i].PKG_CD);
                    }
                    chkArr = chkArr.join('|');

                    if(temp.length > 0){
                        for (var i = 0; i < data.length; i++) {
                            if (chkArr.indexOf(data[i].PKG_CD) == -1) {
                                temp2.push(data[i]);
                            }
                        }
                ...
                initView: function () {
                    ...
                    this.target = axboot.gridBuilder({
                        ...
                        columns: [
                            ...
                            {key: "PKG_CD", label: "패키지코드", width: 120, align: "center", editor: false},
                            {key: "PKG_NM", label: "패키지명", width: 180, align: "center", editor: false},
                            {key: "PKG_AM", label: "금액", width: 180, align: "center", editor: false},
                        ],
                        body: {
                            onClick: function () {
