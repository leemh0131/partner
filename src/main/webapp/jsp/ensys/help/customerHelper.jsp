	        ...
	        var ACTIONS = axboot.actionExtend(fnObj, {
	            ...
	            PAGE_SEARCH: function (caller, act, data) {
	                ...
	                for (var i = 0; i < temp.length; i++) {
	                    chkArr.push(temp[i].CUSTOMER_CD);
	                }
	                chkArr = chkArr.join('|');
	                if(temp.length > 0){
	                    for (var i = 0; i < data.length; i++) {
	                        if (chkArr.indexOf(data[i].CUSTOMER_CD) == -1) {
	                            temp2.push(data[i]);
	                        }
	                    }
                ...
                initView: function () {
                    ...
                    this.target = axboot.gridBuilder({
                        ...
                        columns: [
                        	...
                        	{key: "CUSTOMER_CD", label: "고객사 코드", width: 200, align: "center", editor: false, sortable: true},
                            {key: "CUSTOMER_NM", label: "고객사 명", width: "*", align: "left", editor: false, sortable: true}
                        ],
                        body: {
                            onClick: function () {
