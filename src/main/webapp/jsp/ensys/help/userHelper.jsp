...
<ax:set key="title" value="사용자 검색 도움창"/>
                ...
                PAGE_SEARCH: function (caller, act, data) {
                    ...
                    if(temp.length > 0){
                        for (var i = 0; i < data.length; i++) {
                            if (chkArr.indexOf(data[i].USER_ID) == -1) {
                                temp2.push(data[i]);
                            }
                        }
                ...
                initView: function () {
                    ...
                    this.target = axboot.gridBuilder({
                        ...
                        columns: [
                            ...
                            {key: "USER_ID", label: "사용자아이디", width: 100, align: "center", editor: false},
                            {key: "USER_NM", label: "사용자명", width: 100, align: "center", editor: false},
                        ],
                        body: {
                            onClick: function () {
