...
<ax:set key="title" value="귀속사업장 도움창"/>
            ...
            var ACTIONS = axboot.actionExtend(fnObj, {
                ...
                PAGE_SEARCH: function (caller, act, data) {
                    ...
                    for (var i = 0; i < temp.length; i++) {
                        chkArr.push(temp[i].BIZAREA_CD);
                    }
                    chkArr = chkArr.join('|');

                    if(temp.length > 0){
                        for (var i = 0; i < data.length; i++) {
                            if (chkArr.indexOf(data[i].BIZAREA_CD) == -1) {
                                temp2.push(data[i])
                            }
                        }
                ...
                initView: function () {
                    ...
                    this.target = axboot.gridBuilder({
                        ...
                        columns: [
                            ...
                            {key: "BIZAREA_CD", label: "사업장코드", width: 100, align: "center", editor: false, sortable: true},
                            {key: "BIZAREA_NM", label: "사업장명", width: "*", align: "left", editor: false, sortable: true},
                        ],
                        body: {
                            onClick: function () {
