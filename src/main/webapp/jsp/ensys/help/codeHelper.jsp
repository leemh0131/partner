                ...
                initView: function () {
                    ...
                    this.target = axboot.gridBuilder({
                        ...
                        columns: [
                            ...
                            {key: "SYSDEF_CD", label: "코드", width: 200, align: "center", editor: false, sortable: true},
                            {key: "SYSDEF_NM", label: "명", width: "*", align: "left", editor: false, sortable: true}
                        ],
                        body: {
                            onClick: function () {
