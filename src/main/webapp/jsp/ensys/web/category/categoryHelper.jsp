...
<ax:set key="title" value="카테코리 도움창"/>
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript">
                ...
                PAGE_SEARCH: function (caller, act, data) {
                    ...
                    if(temp.length > 0){
                        for (var i = 0; i < data.length; i++) {
                            if (chkArr.indexOf(data[i].CATEGORY_CD) == -1) {
                                temp2.push(data[i]);
                            }
                        }
                ...
                initView: function () {
                    ...
                    this.target = axboot.gridBuilder({
                        ...
                        columns: [
                            ...
                            {key: "CATEGORY_CD", label: "코드", width: 80, align: "center", editor: false},
                            {key: "CATEGORY_NM", label: "명", width: 120, align: "center", editor: false},
                        ],
                        body: {
                            onClick: function () {
		    ...
		    $(document).ready(function () {
                ...
                if(nvl(initData.initData.PARTNER_TP) == '' || nvl(initData.initData.CODE) == '' ){
                    qray.alert("도움창 설정이 잘못되었습니다.");
                    ACTIONS.dispatch(ACTIONS.PAGE_CLOSE);
                    return;
                }
