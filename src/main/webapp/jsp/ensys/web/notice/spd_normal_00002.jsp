        ...
        <script type="text/javascript">
            ...
            var ACTIONS = axboot.actionExtend(fnObj, {
                PAGE_SEARCH: function (caller, act, data) {
                    ...
                    axboot.ajax({
                        ...
                        callback: function (res) {
                            totalDataCount = res.map.TOT_PAGE;
                            totalPageCount = Math.ceil(res.map.TOT_PAGE / paging_size);
                        }
                    });
                    ...
                    axboot.ajax({
                        ...
                        callback: function (res) {
                            ...
                            for (var i = 0; i < res.list.length; i++) {
                                ...
                                html += "<td>" + $.changeDataFormat(result.INSERT_DTS, "yyyyMMddhhmmss") + "</td>";
                                html += "<td>" + result.USER_NM + "</td>";
                ...
                ITEM_WRITE: function (caller, act, data) {
                    ...
                    $.openCommonPopup("/jsp/ensys/spd/normal/web_notice_write.jsp", "userCallBack", null, '', {BOARD_TYPE: BOARD_TYPE}, _pop_width1000, _pop_height, _pop_top);
            ...
            fnObj.pageStart = function () {
                ...
                page = Number(nvl(InitData["page"], '') != '' ? InitData["page"] : page);
                ...
                if (SCRIPT_SESSION.groupCd != 'WEB01'){
                    $("#write").remove();
                }
                ACTIONS.dispatch(ACTIONS.PAGE_SEARCH);
            };
    ...
    <jsp:body>
        ...
        <div data-page-buttons="">
            <div class="button-warp">
                ...
                <button type="button" class="btn btn-info" data-page-btn="write" id="write" style="width:80px;"><i
                        class="icon_add"></i>
                    쓰기
                </button>
                <button type="button" class="btn btn-info" TRIGGER_NAME="SEARCH" data-page-btn="search" style="width:80px;"><i
                ...
                <ax:tbl clazz="ax-search-tb1" minWidth="500px">
                    <ax:tr>
                        ...
                        <ax:td label='검색내용' width="300px">
                            <input type="text" class="form-control" id="KEYWORD" TRIGGER_TARGET="SEARCH">
                        </ax:td>
                    </ax:tr>
                </ax:tbl>
            </ax:form>
