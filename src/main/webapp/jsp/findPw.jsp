...
<ax:layout name="base">
    ...
    <jsp:body>
        ...
        <div class="header_wrap">
            ...
            <h2 class="title" style="padding: 25px; margin-left:30px;"><i class="cqc-browser2"></i>비밀번호 찾기</h2>
        </div>
        ...
        <div style="padding: 100px;">
            ...
            <div class="ax-button-group" data-fit-height-aside="grid-view-01">
                <div class="left">
                    ...
                    <h4><font style="color:#00ffff;">*</font> 해당 정보가 일치하는 경우 등록된 이메일로 변경된 임시비밀번호가 전송됩니다. </h4>
