...
//	nRet = TSToolkit.VerifyVID("120861585");
    ...
    var cert  = new Array(certdn,certkey,cert_R);
...
//		return false;
    ...
    if (newPwd)
    {
        ...
        */
        ...
        var cert  = new Array("",signCert,signPri2,cert_R);
        return cert;
    }
...
//		TSToolkit.GetCertificatePropertyFromID(cert, CERT_ATTR_ISSUER_DN);
        ...
        // YMD_EXPIRE   인증서만료일자
        // newPwd		인증서암호
        var cert  = new Array("",signCert,signPri2,cert_R,CERT_NM,CERT_USER,CERT_ORG,YMD_START,YMD_EXPIRE,newPwd);
        return cert;
    }
